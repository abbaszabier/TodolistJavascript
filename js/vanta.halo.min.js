  ...
  (() => {
    ...
    s.VantaBase = class {
      constructor(e = {}) {
        ...
        if (
          ...
          const e = this.el;
          if (((this.el = ((i = e), document.querySelector(i))), !this.el)) return void r("Cannot find element", e);
        }
        var i, a;
        ...
        try {
          ...
          return (
            ...
            void (
              this.options.backgroundColor && (console.log("[VANTA] Falling back to backgroundColor"), (this.el.style.background = ((a = this.options.backgroundColor), "number" == typeof a ? "#" + ("00000" + a.toString(16)).slice(-6) : a)))
            )
          );
        }
        ...
        c("resize", this.resize),
          ...
          this.options.mouseControls && (c("scroll", this.windowMouseMoveWrapper), c("mousemove", this.windowMouseMoveWrapper)),
          this.options.touchControls && (c("touchstart", this.windowTouchWrapper), c("touchmove", this.windowTouchWrapper)),
          this.options.gyroControls && c("deviceorientation", this.windowGyroWrapper);
      }
      setOptions(e = {}) {
      ...
      destroy() {
        ...
        const t = this.scene;
        t && t.children && i(t), this.renderer && (this.renderer.domElement && this.el.removeChild(this.renderer.domElement), (this.renderer = null), (this.scene = null)), s.current === this && (s.current = null);
      }
    };
    const a = s.VantaBase;
    ...
    class h extends a {
      ...
      init() {
        (this.mode = "shader"),
          (this.uniforms = {
            ...
            iMouse: { type: "v2", value: new c.Vector2(this.mouseX || 0, this.mouseY || 0) },
          }),
          super.init(),
      ...
      initBasicShader(e = this.fragmentShader, t = this.vertexShader) {
        ...
        const i = new c.ShaderMaterial({ uniforms: this.uniforms, vertexShader: t, fragmentShader: e }),
          n = this.options.texturePath;
        n && (this.uniforms.iTex = { type: "t", value: new c.TextureLoader().load(n) });
        const o = new c.Mesh(new c.PlaneGeometry(2, 2), i);
        this.scene.add(o), (this.camera = new c.Camera()), (this.camera.position.z = 1);
      }
      updateUniforms() {
        const e = {};
        let t, i;
        for (t in this.options) (i = this.options[t]), -1 !== t.toLowerCase().indexOf("color") ? (e[t] = { type: "v3", value: new c.Color(i).toVector() }) : "number" == typeof i && (e[t] = { type: "f", value: i });
    ...
    class u extends h {
      ...
      getDefaultOptions() {
        return { baseColor: 6745, color2: 15918901, backgroundColor: 1251907, amplitudeFactor: 1, ringFactor: 1, rotationFactor: 1, xOffset: 0, yOffset: 0, size: 1, speed: 1, mouseEase: !0, scaleMobile: 1, scale: 1 };
      }
      onInit() {
        const e = { minFilter: l.LinearFilter, magFilter: l.LinearFilter, format: l.RGBFormat },
          t = (this.width * window.devicePixelRatio) / this.scale,
          i = (this.height * window.devicePixelRatio) / this.scale;
        (this.bufferTarget = new l.WebGLRenderTarget(t, i, e)), (this.bufferFeedback = new l.WebGLRenderTarget(t, i, e));
      }
      initBasicShader(e, t) {
        super.initBasicShader(e, t), (this.uniforms.iBuffer = { type: "t", value: this.bufferTarget.texture });
      }
      onUpdate() {
